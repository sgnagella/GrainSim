...
[1] Temporal Integrators for Fluctuating Hydrodynamics. Delong et. al. (2013)
Phys. Rev. E 87, 033302. [2] Brownian dynamics of confined suspensions of active
microrollers. Balboa et. al. (2017) J. Chem. Phys. 146;
...
public:
  ...
  BaseBrownianIntegrator(shared_ptr<ParticleData> pd, Parameters par)
      : BaseBrownianIntegrator(std::make_shared<ParticleGroup>(pd, "All"),
                               par) {}
...
public:
  ...
  MidPoint(shared_ptr<ParticleData> pd, Parameters par)
...
public:
  ...
  Leimkuhler(shared_ptr<ParticleData> pd, Parameters par)
...
#include "BrownianDynamicsPBC.cu"
#endif
